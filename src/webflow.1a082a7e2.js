...
! function () {
  ...
  window.tram = function (t) {
    ...
    $.transform && (Q.transform = [N], J = {
      ...
      skewX: [_],
      skewY: [_]
    }), $.transform && $.backface && (J.z = [k, "translateZ"], J.rotateZ = [_], J.scaleZ = [y], J.perspective = [x]);
    var V = /ms/,
      K = /s|\./;
    return t.tram = e
  }(window.jQuery);
  ...
  t(function (t) {
    ...
    e.define("ix", t.exports = function (t, i) {
        ...
        if (c) {
          ...
          l && (w.style(a, c.style), i.each(l, function (t) {
            ...
            if ("load" !== u) {
              ...
              if ("hover" === u) return a.on("mouseenter" + y, i), a.on("mouseleave" + y, r), void(E = E.add(a));
              if ("scroll" !== u) {
                var l = q[u];
                if (l) {
                  var f = a.closest(l);
            ...
            } else t.preload && !k ? j.push(i) : A.push(i)
          }))
        }
      }
      ...
      return w.init = function (t) {
        ...
        m = !0, E.each(u), e.scroll.off(c), n.async(), z = [], j = [], A = []
      }, w.ready = function () {
    ...
    e.define("navbar", t.exports = function (t, i) {
      ...
      function m(e) {
        return e.outside && j.off("tap" + q, e.outside), i.debounce(function (n) {
          if (e.open) {
      ...
      function y(t, n) {
        if (!t.open) {
          t.open = !0, t.menu.addClass(C), t.links.addClass(D), t.button.addClass($);
          var i = t.config;
          ...
          var r = b(t),
            ...
            s = t.el.height(),
            u = t.el[0];
          if (w(0, u), I.intro(0, u), e.redraw.up(), T || j.on("tap" + q, t.outside), !n) {
      ...
      function x(t, e) {
        function n() {
          t.menu.height(""), O(t.menu).set({
            x: 0,
            y: 0
          }), t.menu.removeClass(C), t.links.removeClass(D), t.overlay && t.overlay.children().length && (L.length ? t.menu.insertAfter(L) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
        }
        if (t.open) {
          t.open = !1, t.button.removeClass($);
          var i = t.config;
          if (("none" === i.animation || !O.support.transform || i.duration <= 0) && (e = !0), I.outro(0, t.el[0]), j.off("tap" + q, t.outside), e) return O(t.menu).stop(), void n();
      ...
      E.ready = E.design = E.preview = function () {
        T = A && e.env("design"), k = t(document.body), (_ = j.find(q)).length && (_.each(s), r(), o())
      }, E.destroy = function () {
    ...
    e.define("slider", t.exports = function (t, i) {
      ...
      function u(e, n) {
        ...
        if (r || (r = t.data(n, q, {
            ...
            el: i,
            config: {}
          })), r.mask = i.children(".w-slider-mask"), r.left = i.children(".w-slider-arrow-left"), r.right = i.children(".w-slider-arrow-right"), r.nav = i.children(".w-slider-nav"), r.slides = r.mask.children(".w-slide"), r.slides.each(C.reset), O && (r.maskWidth = 0), !j.support.transform) return r.left.hide(), r.right.hide(), r.nav.hide(), void(E = !0);
